...
% example solution:
%cabinetTOthing(9,3). cabinetTOthing(9,4). cabinetTOthing(9,5). cabinetTOthing(9,6). cabinetTOthing(9,7). cabinetTOthing(10,8). roomTOcabinet(15,9). roomTOcabinet(16,10).
